...
3. **Optimise** - Table with location, issue, fix, savings estimate
4. **Summary** - Current/potential/savings with top recommendations

See [ANTI-PATTERNS.md](refs/ANTI-PATTERNS.md) for detection patterns and [OPTIMIZATION-PATTERNS.md](refs/OPTIMIZATION-PATTERNS.md) for techniques.

## Rules

- Preserve clarity in all optimizations
- SKILL.md target: <500 tokens, refs: <1000 tokens

## References

- [OPTIMIZATION-PATTERNS.md](refs/OPTIMIZATION-PATTERNS.md) - Optimization techniques
- [ANTI-PATTERNS.md](refs/ANTI-PATTERNS.md) - Token-wasting patterns