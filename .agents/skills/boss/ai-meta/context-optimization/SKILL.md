...
description: "Context optimization extends the effective capacity of limited context windows through strategic compression, masking, caching, and partitioning. Use when working with small context LLMs or need to maximize limited token budgets."
category: ai-meta
risk: safe
source: adapted
tags: [context, optimization, compression, tokens, efficiency, llm, small-context]
triggers: [optimize, compress, context, tokens, efficiency, small, limited, window]
...
- Needing to maximize limited token budgets
