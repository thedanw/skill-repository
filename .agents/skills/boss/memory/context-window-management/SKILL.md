...
description: "Strategies for managing LLM context windows including summarization, trimming, routing, and avoiding context rot. Use when working with small context LLMs or need to manage limited token budgets effectively."
category: memory
risk: safe
source: adapted
tags: [context, window, management, tokens, summarization, trimming, routing, small-context]
triggers: [manage, context, window, tokens, summarize, trim, route, limit]
...
- Working with small context LLMs (4K-32K tokens)
- Needing to manage limited token budgets effectively
